...
function draw() {
  ...
  //////////////////////////////////////////////
  for (var a = 20; a <= 2000; a += 50) {
    for (var b = 20; b <= 2000; b += 50) {
      fill(255, 255, 255);
      rect(b, a, 10, 10);
      strokeWeight(4);
    }
  ...
  push();
  textSize(70);
  text("HIGH SCORE:", 10, 60);
  text(particles.length, 500, 60);
  fill(0);
  pop();
  push();
  text("PRESS ENTER TO SCORE & ARROW KEYS FOR CONTROL", 15, 90);
  textSize(20);
  fill(255, 255, 255);
  pop();
  /////////////////////////////////////////////////////
  image(pic, 1450, 5, 90, 90);
  image(photo, 1550, 5, 90, 90);
  image(apple, 1650, 5, 90, 90);
